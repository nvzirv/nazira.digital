...
const DOMinit = () => {
  ...
  var output = document.getElementById("mdemo");
  ...
  var output = document.getElementById("ndemo");
  output.innerHTML = nSlider.nvalue; // Display the default slider value

  // // Update the current slider value (each time you drag the slider handle)
  nSlider.oninput = function() {
    output.innerHTML = this.nvalue;
  }
